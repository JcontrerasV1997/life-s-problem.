class CellularAutomata {
    ...
    evaluate() {
        let cellsaAux = new Array(100).fill("").map(() => new Array(100).fill(false));
        for (let x = 0; x < this.size; x++) {
            for (let y = 0; y < this.size; y++) {
                ...
                if (this.cells[x][y])
                    cellsaAux[x][y] = livingNeighbor == 2 ||
                        livingNeighbor == 3 ? true : false
                else
                    cellsaAux[x][y] = livingNeighbor == 3 ? true : false


            }
            
        }
        this.cells=cellsaAux;
    }
